  ...
  phenotype
    ~ multi_normal(intercept,
                   ...
                   * add_diag(tcrossprod(diag_post_multiply(predictor_matrix_norm,variance_components[1:NV]))
                              ...
                              + variance_components[NV+3] * cor_1e
                              + variance_components[NV+4] * cor_2e
                              + variance_components[NV+5] * cor_1_2
                              , variance_components[NV+6] + 1e-9));
}
