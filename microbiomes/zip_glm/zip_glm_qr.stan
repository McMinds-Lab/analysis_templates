...
parameters {
    ...
    matrix[NB_s+K_s,NB_f]              beta_prevalence_i_tilde;
    matrix[NB_s+K_s,NF]                beta_prevalence_s_tilde;
    matrix[NS,NB_f]                    beta_prevalence_f_tilde;
...
transformed parameters {
    ...
    beta_prevalence_i[1,]         = beta_prevalence_i_tilde[1,];
    beta_prevalence_i[,1]         = beta_prevalence_i_tilde[,1];
    beta_prevalence_i[(NB_s+1):,] = beta_prevalence_i_tilde[(NB_s+1):,];
    beta_prevalence_i[2:NB_s,2:]  = X_sR_inv * beta_prevalence_i_tilde[2:NB_s,2:] * X_fR_inv;
    beta_prevalence_s[1,]         = beta_prevalence_s_tilde[1,];
    beta_prevalence_s[(NB_s+1):,] = beta_prevalence_s_tilde[(NB_s+1):,];
    beta_prevalence_s[2:NB_s,]    = X_sR_inv * beta_prevalence_s_tilde[2:NB_s,];
    beta_prevalence_f[,1]         = beta_prevalence_f_tilde[,1];
    beta_prevalence_f[,2:]        = beta_prevalence_f_tilde[,2:] * X_fR_inv;
