...
model {
    ...
    target += normal_lpdf(to_vector(beta_abundance_i) | 0, to_vector(sd_abundance[idxk_s, rep_array(NFB,NF)]));
    target += normal_lpdf(to_vector(beta_abundance_s) | 0, to_vector(sd_abundance[idxk_s, idx_f2]));
